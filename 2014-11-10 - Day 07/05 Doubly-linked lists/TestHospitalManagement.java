...
public class TestHospitalManagement {
    public static void main( String[] args ) {
		...
		hm.addPatient(p10);
		hm.printList();
		System.out.println("List length: "+hm.lengthI());

        hm.deletePatient("Test 4");
		hm.printList();
		System.out.println("List length after deletion: "+hm.lengthI());

		hm.addPatient(new Patient("Test 11",33,"outch 11"));
        hm.deletePatient("Test 1000");
		hm.printList();
		System.out.println("Added Test 11, tried to delete 1000: "+hm.lengthI());
